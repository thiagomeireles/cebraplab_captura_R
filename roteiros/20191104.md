...
```
 ...
 - Caso seu computador pessoal seja [Mac](https://medium.com/@GalarnykMichael/install-r-and-rstudio-on-mac-e911606ce4f4) ou [Linux](https://www.ibpad.com.br/blog/analise-de-dados/aprenda-instalar-o-r-e-o-r-studio/), converse comigo em caso de falha nos tutoriais linkados.
